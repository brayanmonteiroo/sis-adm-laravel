        ...
        <div class="col-12 col-sm-8 col-md-6 col-lg-5">
            <div class="card bg-light text-dark shadow-lg border-0 rounded-4 p-4">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('login.process') }}" method="POST">
                        ...
                        <div class="form-floating mb-3">
                            <input class="form-control" id="email" type="email" name="email" placeholder="nome@exemplo.com" value="{{ old('email') }}" />
                ...
                <div class="card-footer bg-transparent border-0 text-center">
                    <div class="small"><a href="#" class="text-decoration-none">Não tem uma conta? Cadastre-se!</a></div>
                </div>
            </div>
        </div>
    </div>
